  ...
  return (
    <PageTransition>
      <div className="mx-auto max-w-5xl px-4 py-12">
        ...
        <div className="mt-8 grid gap-10 md:grid-cols-[minmax(0,360px)_1fr]">
          <div>
          ...
          <div>
            ...
            {track.lyrics ? (
              <section className="mt-8 max-h-64 overflow-y-auto rounded-lg border border-zinc-800 p-4">
                <h2 className="text-sm font-medium text-zinc-400">歌词</h2>
                <pre className="mt-3 whitespace-pre-wrap text-sm leading-8 text-zinc-200">
                  {track.lyrics}
                </pre>
              </section>
            ) : null}
